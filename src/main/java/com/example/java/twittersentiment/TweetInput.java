...
public class TweetInput implements InputOperator, Operator.ActivationListener<Context.OperatorContext>, StatusListener
{
  String tweet;
  /**
...
*/
  ...
  @NotNull
  // need to enter the keys provided by twitter after registering as twitter developer
  private String consumerKey = "Enter credentials";
  @NotNull
  private String consumerSecret = "Enter credentials";
  @NotNull
  private String accessToken = "Enter credentials";
  @NotNull
  private String accessTokenSecret = "Enter credentials";
  ...
  private void setUpTwitterConnection()
  {
    ...
    ts = new TwitterStreamFactory(cb.build()).getInstance();
    ts.addListener(TweetInput.this);
  ...
  public boolean equals(Object obj)
  {
    ...
    final TweetInput other = (TweetInput)obj;
  ...
  private static final Logger logger = LoggerFactory.getLogger(TweetInput.class);
}
